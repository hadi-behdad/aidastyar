            ...
            try {
                ...
                if (parsedData.response) {
                    try {
                        ...
                        contentContainer.innerHTML = '<div class="accordion-section"><div class="accordion-header"><h2><i class="fas fa-exclamation-triangle"></i> نتایج برنامه غذایی</h2><i class="fas fa-chevron-down accordion-icon"></i></div><div class="accordion-content"><div class="accordion-content-inner"><div class="error">' + parsedData.response + '</div></div></div></div>';
                    }
                } else {
                ...
                contentContainer.innerHTML = '<div class="accordion-section"><div class="accordion-header"><h2><i class="fas fa-exclamation-triangle"></i> خطا</h2><i class="fas fa-chevron-down accordion-icon"></i></div><div class="accordion-content"><div class="accordion-content-inner"><p>خطا در پردازش داده‌ها</p></div></div></div>';
            }
        } else {
            debugContainer.innerHTML = '<div class="error"><i class="fas fa-exclamation-circle"></i> هیچ داده‌ای در sessionStorage یافت نشد</div>';
            contentContainer.innerHTML = '<div class="accordion-section"><div class="accordion-header"><h2><i class="fas fa-exclamation-triangle"></i> داده‌ای یافت نشد</h2><i class="fas fa-chevron-down accordion-icon"></i></div><div class="accordion-content"><div class="accordion-content-inner"><p>داده‌ای برای نمایش وجود ندارد.</p></div></div></div>';
        }
        
        // اضافه کردن event listener برای آکاردئون‌ها
    ...
    function initAccordions() {
        ...
        accordionHeaders.forEach(header => {
            header.addEventListener('click', function() {
                // حالت toggle - اگر باز است بسته شود، اگر بسته است باز شود
