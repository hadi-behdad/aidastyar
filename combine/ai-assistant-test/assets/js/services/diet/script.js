...
window.VALUE_MAPPING = {
    ...
    medications: {
        ...
        'supplements': 'مکمل‌های ویتامین و معادن',
        'immunosuppressants': 'داروهای سرکوب ایمنی (پیوند، روماتولوژی)',
        'cancer-oral': 'داروهای ضدسرطان خوراکی / تارگت‌تراپی',
        'anticonvulsant': 'داروهای ضدصرع / عصبی',
        'weight-loss': 'داروهای لاغری / GLP-۱',
